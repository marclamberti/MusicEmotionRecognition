function [sone, Ntot,p] = TL_SONE(wav,p)

%% Example:
%% [A,B,C] = wavread('BaCl.mf.C4B4_3.wav');
%% p = struct('fs',B,'do_visu',1,'do_sone',1,'do_spread',1,'outerear','terhardt','fft_size',256,'hopsize',128,'bark_type','table','dB_max',96)
%% [sone, Ntot, p] = TL_SONE(A,p);
%% figure; plot(sone');   ---> Sone/Bark bands/time
%% figure; plot(Ntot);    ---> Total Loudness/time
